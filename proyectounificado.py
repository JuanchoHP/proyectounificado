...
posicion_x = int((ancho_pantalla - ancho) / 2)
posicion_y = int((alto_pantalla - alto) / 2)

raiz.geometry(f"{ancho}x{alto}+{posicion_x}+{posicion_y}")
...
Label(miFrame, text="Nombre").grid(
    row=1,
    column=0,
    padx=5,
    pady=5
...
Label(miFrame, text="Password").grid(
    row=2,
    column=0,
    padx=5,
    pady=5
...
Label(miFrame, text="Apellido").grid(
    row=3,
    column=0,
    padx=5,
    pady=5
...
Label(miFrame, text="Dirección").grid(
    row=4,
    column=0,
    padx=5,
    pady=5
...
Label(miFrame, text="Comentarios").grid(
    row=5,
    column=0,
    padx=5,
    pady=5,
...
tabla.heading("COMENTARIOS", text="Comentarios")
...
tabla.column("PASSWORD", width=120)
tabla.column("APELLIDO", width=150)
tabla.column("DIRECCION", width=200)
tabla.column("COMENTARIOS", width=300)
